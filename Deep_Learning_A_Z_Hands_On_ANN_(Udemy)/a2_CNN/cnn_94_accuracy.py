...
training_set_path = os.path.join(script_dir, 'data/training_set')
test_set_path = os.path.join(script_dir, 'data/test_set')
...
# Save model
model_backup_path = os.path.join(script_dir, 'data/cat_or_dogs_model.h5')
