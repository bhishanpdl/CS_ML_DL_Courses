...
!cmd: clear;f90 hw5qn1sp.f90 && ./a.out
...
!      parameter (ng=8)
      ...
      open(kwrite, File = 'hw5qn1sp.dat', Status = 'Unknown')
      
      write (kwrite,10000) '#N','h','T-rule','S-rule','G-Quad','eT','eS','eG'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   10000 format(A3,2x,A4,6x,A,1x,A10,4x,A6,3(4x,A10))
   10001 format(I3, F9.4,3F10.6,3E16.6)  
   
   close(kwrite)
   stop 'data saved in hw5qn1sp.dat'
   end program hw5qn1
