...
!cmd       : clear; f90 qn2WithJumps.f90 && ./a.out

program qn2WithJumps
implicit none
     ...
     !calculate and display value of pi
      ...
      write (*,100) i,phi,x,y,sqrtz,lnz,arctan,arctan2
   ...
   open(unit = 9, file='qn2WithJumps.dat', status='replace') !replacing old file if exitsts
        ...
        do i=-16,16,1
            ...
            write (9,110) i,phi,x,y,sqrtz,lnz,arctan,arctan2

      end do
      110 format(i4,9(2x,f8.2))  ! formatting for 1 integer and 9 float points  
   
   close(unit =9)
   
   
end program qn2WithJumps
