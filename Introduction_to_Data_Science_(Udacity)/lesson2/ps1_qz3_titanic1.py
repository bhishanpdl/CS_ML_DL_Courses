...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        cls1 = passenger['Pclass'] == 1
        cls2 = passenger['Pclass'] == 2
        cls3 = passenger['Pclass'] == 3
        child = passenger['Age'] < 15
        if (female and cls1) or (female and cls2):
            predictions[passenger_id] = 1
        if (child and cls1) or (child and cls2):
            predictions[passenger_id] = 1
