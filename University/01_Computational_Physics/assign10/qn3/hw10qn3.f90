!cmd: clear; f95 hw10qn3.f90 && ./a.out; rm -f *~															 
	...
	max	 = 250000
	open(9, FILE='hw10qn3a.dat', Status='Unknown')
	open(10, FILE='hw10qn3b.dat', Status='Unknown')
	...
	close(9)
	close(10)
	stop 'data saved in hw10qn3a.dat and hw10qn3b.dat'
	end program
...
! function calculates energy of the system
	...
	energy=0
	do	i=1,(max-1)
		 energy=energy + (array(i+1)-array(i))**2 + abs(array(i))
	end do
	return
	end
