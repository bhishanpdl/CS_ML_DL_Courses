...
!bp: clear; gfortran -framework vecLib hw7qn2plot.f90 && ./a.out
!bp: clear; gfortran -framework vecLib hw7qn2plot.f90 && ./a.out > matrix3.dat

!bp: clear; f95 -llapack hw7qn2plot.f90 && ./a.out
!note: change values of nstep to change value of h, change 100,200,300,400,500.
...
!   writing output to a file
    open(45,file='third.dat',status='unknown',access='append')
    write(45,200) h, w(3)
    !write(45,200) h, w(1),w(2), w(3)
